...
#define CRUISE_CONTROL_PID_Kp (0.027)
#define CRUISE_CONTROL_PID_Ki (0.0000024)
#define CRUISE_CONTROL_PID_Kd (0)
#define CRUISE_CONTROL_OVERRIDE_PEDAL_MIN (0.025)
#define CRUISE_CONTROL_MAX_SPEED_OVERSHOOT (1.0)
#define CRUISE_CONTROL_MAX_ACCELERATION_MS2_LOWER_BOUND (0.05)
#define CRUISE_CONTROL_MAX_ACCELERATION_MS2_UPPER_BOUND (0.4)
...
#define CAR_GAS_PEDAL_ADC_CHANNEL_0 ADC_CHANNEL_6    // Mapped to PIN 34
#define CAR_GAS_PEDAL_ADC_CHANNEL_1 ADC_CHANNEL_7    // Mapped to PIN 35
#define CAR_GAS_PEDAL_ADC_SAMPLE_COUNT (20)
#define CAR_GAS_PEDAL0_MIN_VOLTS (0.37)
#define CAR_GAS_PEDAL1_MIN_VOLTS (0.68)
#define CAR_GAS_PEDAL0_MAX_VOLTS (2.04)
#define CAR_GAS_PEDAL1_MAX_VOLTS (4.07)
...
#define CAR_GEAR_RATIO_SLACK (1.0)
#define CAR_GEAR_1_RATIO (9.0)
#define CAR_GEAR_2_RATIO (16.4)
#define CAR_GEAR_3_RATIO (24.2)
#define CAR_GEAR_4_RATIO (32.8)
#define CAR_GEAR_5_RATIO (41.2)

#define CAR_SPEED_AVERAGE_PERIOD_MS (100)

#define BUTTONS_ADC_CHANNEL_0 ADC_CHANNEL_0    // Mapped to PIN 36
#define BUTTONS_ADC_CHANNEL_1 ADC_CHANNEL_3    // Mapped to PIN 39
...
#define DISPLAY_LONG_BLINK_INTERVAL (750)
#define DISPLAY_SHORT_BLINK_INTERVAL (750)
#define DISPLAY_SHORT_BLINK_PULSE_LENGTH (150)
...
#define SD_FILE_SEARCH_MIN_POWER (8)
#define SD_FILE_SEARCH_MAX_POWER (15)
...
#define GPSGSM_MESSAGE_MAX_TIMEOUT_MS (120000)
