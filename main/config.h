...
#define CRUISE_CONTROL_OVERRIDE_PEDAL_MIN (0.03)
#define CRUISE_CONTROL_MAX_ACCELERATION_MS2_LOWER_BOUND (0.3)
#define CRUISE_CONTROL_MAX_ACCELERATION_MS2_UPPER_BOUND (0.5)
...
#define CAR_GEAR_RATIO_SLACK (0.7)
