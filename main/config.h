...
#define CRUISE_CONTROL_OVERRIDE_PEDAL_MIN (0.035)
#define CRUISE_CONTROL_MAX_ACCELERATION_MS2_LOWER_BOUND (0.2)
...
#define CAR_GAS_PEDAL0_MAX_VOLTS (2.07)
#define CAR_GAS_PEDAL1_MAX_VOLTS (4.14)
