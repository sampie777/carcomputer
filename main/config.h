...
#define CRUISE_CONTROL_PID_Kp (0.025)
#define CRUISE_CONTROL_PID_Ki (0.0000022)
#define CRUISE_CONTROL_PID_Kd (0)
#define CRUISE_CONTROL_OVERRIDE_PEDAL_MIN (0.025)
#define CRUISE_CONTROL_MAX_SPEED_OVERSHOOT (1.5)
#define CRUISE_CONTROL_MAX_ACCELERATION_MS2_LOWER_BOUND (0.15)
