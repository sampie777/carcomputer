...
#define CAN_IGNITION_DRIVERS_SEATBELT_BIT 1
...
#define CAN_ODOMETER_PARKING_BRAKE_BIT 2

/* Gear and lights message */
#define CAN_ID_GEAR_LIGHTS 1549
#define CAN_LENGTH_GEAR_LIGHTS 8
#define CAN_GEAR_LIGHTS_IGNITION_BIT 5
#define CAN_GEAR_LIGHTS_REVERSE_BIT 4
#define CAN_GEAR_LIGHTS_IS_LOCKED_BIT 4
